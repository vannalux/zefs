...
if ( ! function_exists( 'adobe_muse_enqueue_scripts' ) ) :
    ...
    wp_enqueue_script( 'adobe_muse-script', null, null, '1.0.4', true );

    wp_register_script( 'adobe_muse-script', '', [], '1.0.4', true );
    wp_enqueue_script( 'adobe_muse-script' );
    wp_add_inline_script( 'adobe_muse-script', '// Decide whether to suppress missing file error or not based on preference setting
var suppressMissingFileError = false');
    ...
    wp_register_script( 'adobe_muse-script', '', [], '1.0.4', true );
    wp_enqueue_script( 'adobe_muse-script' );
    wp_add_inline_script( 'adobe_muse-script', 'window.Muse.assets.check=function(c){if(!window.Muse.assets.checked){window.Muse.assets.checked=!0;var b={},d=function(a,b){if(window.getComputedStyle){var c=window.getComputedStyle(a,null);return c&&c.getPropertyValue(b)||c&&c[b]||""}if(document.documentElement.currentStyle)return(c=a.currentStyle)&&c[b]||a.style&&a.style[b]||"";return""},a=function(a){if(a.match(/^rgb/))return a=a.replace(/\s+/g,"").match(/([\d\,]+)/gi)[0].split(","),(parseInt(a[0])<<16)+(parseInt(a[1])<<8)+parseInt(a[2]);if(a.match(/^\#/))return parseInt(a.substr(1),
...
Muse.Utils.transformMarkupToFixBrowserProblems();/* body */
    ...
    wp_enqueue_script( 'adobe_muse-require', get_template_directory_uri() . '/scripts/require.js?crc=7928878', null, '1.0.4', true );

    wp_register_script( 'inline-script-1', '', [], '1.0.4', false );
...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.watch.js", "jquery.musepolyfill.bgsize.js", "jquery.scrolleffects.js", "jquery.museresponsive.js", "require.js", "index.css"], "outOfDate":[]};');
    ...
    wp_enqueue_style( 'adobe_muse-site_global', get_template_directory_uri() . '/css/site_global.css?crc=314571582', [], '1.0.4', 'all');

    wp_deregister_style( 'adobe_muse-master_______a' );
    wp_enqueue_style( 'adobe_muse-master_______a', get_template_directory_uri() . '/css/master_______-a.css?crc=4084118096', [], '1.0.4', 'all');

    wp_deregister_style( 'adobe_muse-index' );
    wp_enqueue_style( 'adobe_muse-index', get_template_directory_uri() . '/css/index.css?crc=3770484610', [], '1.0.4', 'all');

    wp_deregister_style( 'adobe_muse-style' );
    wp_enqueue_style( 'adobe_muse-style', get_bloginfo('stylesheet_url'), [], '1.0.4', 'all');
