...
var suppressMissingFileError = false');
    ...
    wp_register_script( 'inline-script-3', '', [], '1.0.1', true );
...
Muse.Utils.transformMarkupToFixBrowserProblems();/* body */
    ...
    wp_enqueue_script( 'adobe_muse-require', get_template_directory_uri() . '/scripts/require.js?crc=7928878', [], '1.0.1', true);
    ...
    wp_enqueue_style( 'adobe_muse-site_global', get_template_directory_uri() . '/css/site_global.css?crc=314571582', [], '1.0.1', 'all');

    wp_deregister_style( 'adobe_muse-master_______a' );
    wp_enqueue_style( 'adobe_muse-master_______a', get_template_directory_uri() . '/css/master_______-a.css?crc=4084118096', [], '1.0.1', 'all');

    wp_deregister_style( 'adobe_muse-index' );
    wp_enqueue_style( 'adobe_muse-index', get_template_directory_uri() . '/css/index.css?crc=3770484610', [], '1.0.1', 'all');

    wp_deregister_style( 'adobe_muse-style' );
    wp_enqueue_style( 'adobe_muse-style', get_bloginfo('stylesheet_url'), [], '1.0.1', 'all');
